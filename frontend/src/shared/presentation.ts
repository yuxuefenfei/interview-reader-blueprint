export const statusLabel: Record<string, string> = {
  ...
  DRAFT: "草稿", PUBLISHED: "已发布", RETIRED: "已退役", PDF: "PDF 文档", EXCEL: "Excel 工作簿", MARKDOWN: "Markdown", JSON_PACKAGE: "JSON 文档包", paragraph: "正文", heading_note: "标题说明", unordered_list: "无序列表", ordered_list: "有序列表", code: "代码", table: "表格", quote: "引用", callout: "提示", formula: "公式", image: "图片", divider: "分隔线", table_snapshot: "表格快照"
};
