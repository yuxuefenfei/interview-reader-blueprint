export const statusLabel: Record<string, string> = {
  ...
  DRAFT: "草稿", PUBLISHED: "已发布", OFFLINE: "已下架", DELETING: "删除中", DELETE_FAILED: "删除失败", RETIRED: "已退役", QUEUED: "排队中", RUNNING: "执行中", CLIENT_SYNC_MARKED: "已登记客户端清理", DELETING_FILES: "正在删除文件", DELETING_DATA: "正在删除数据", COMPLETED: "已完成", PDF: "PDF 文档", EXCEL: "Excel 工作簿", MARKDOWN: "Markdown", JSON_PACKAGE: "JSON 文档包", MANUAL: "手工录入", PART: "篇章", CHAPTER: "章节", SECTION: "小节", SUBSECTION: "子节", QUESTION: "面试问题", APPENDIX: "附录", OTHER: "其他", ANSWER: "答案", EXPLANATION: "解析", CONCLUSION: "结论", INTRODUCTION: "导读", DIRECTORY: "目录", PRINCIPLE: "原理", PRACTICE: "实践", PITFALL: "易错点", FOLLOW_UP: "追问", paragraph: "正文", heading_note: "标题说明", unordered_list: "无序列表", ordered_list: "有序列表", code: "代码", table: "表格", quote: "引用", callout: "提示", formula: "公式", image: "图片", divider: "分隔线", table_snapshot: "表格快照"
};
