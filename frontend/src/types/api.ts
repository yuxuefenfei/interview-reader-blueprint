...
export interface VersionSummary { id: string; versionNo: number; parentVersionId: string | null; parentVersionNo: number | null; originImportJobId: string | null; sourceType: string; sourceFileName: string | null; status: "DRAFT" | "PUBLISHED" | "RETIRED"; draftRevision: number; publishedAt: string | null; createdAt: string; }
