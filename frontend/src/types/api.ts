...
export const SEMANTIC_ROLES = ["QUESTION", "ANSWER", "EXPLANATION", "CONCLUSION", "INTRODUCTION", "DIRECTORY"] as const;
...
export const IMPORT_STAGES = ["UPLOADED", "PREFLIGHT", "EXTRACTING", "NORMALIZING", "VALIDATING", "REVIEWING", "FAILED", "CANCELED", "COMMITTED", "DRAFT_DISCARDED"] as const;
